        ...
        <Nav variants={navVariants} animate={navAnimation} initial={"top"}>
            ...
            <Col>
                <Search onSubmit={handleSubmit(onValid)}>
                    ...
                    <Input {...register('keyword' , {required :true , minLength:2})} animate={inputAnimation} initial={{scaleX : 0}} transition = {{type : "linear"}}  placeholder="Search..."></Input>
                </Search>
            </Col>
        </Nav>
    )
